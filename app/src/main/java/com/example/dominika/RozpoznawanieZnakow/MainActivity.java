...
public class
MainActivity extends AppCompatActivity implements OnClickListener, CvCameraViewListener2 {
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        /// Problem z kamera , jezeli Nexus 5x
        ...
        //rozmycie przycietej ramki, w celu usuniecia zaklocen
        Imgproc.GaussianBlur(graytemp, graytemp, new org.opencv.core.Size(7,7),2 , 2);
        //konwersja szarej ramki na dwojkowa, z wykorzystaniem progu adaptacyjnego
        ...
        //pokaz wstepnie przetworzone przyciete zdjecie w lewym gornym rogu
        topcorner= mRgba.submat(0,   height, 0, width);
        ///pokrycie grayscale do BGRA
